...
include $_SERVER['DOCUMENT_ROOT'] . "/api/light.php";
  ...
  $title = "Privacy policy - Todorescu.com";
...
<p> ICE STATION ZEBRA SRL (“we,” “our,” or “us”) is committed to protecting your privacy. This Privacy Policy
    explains how your personal information is collected, used, and disclosed by ICE STATION ZEBRA SRL.</p>
<p>This Privacy Policy applies to our website, and its associated subdomains (collectively, our “Service”) alongside
    our application, ICE STATION ZEBRA SRL. By accessing or using our Service, you signify that you have read,
    understood, and agree to our collection, storage, use, and disclosure of your personal information as described
    in this Privacy Policy and our Terms of Service. This Privacy Policy was created with <a
...
<ul>
    ...
    <li>Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to ICE STATION ZEBRA SRL,
        Horea 79, TEIUS, Alba, Romania that is responsible for your information under this Privacy Policy.</li>
    <li>Country: where ICE STATION ZEBRA SRL or the owners/founders of ICE STATION ZEBRA SRL are based, in this case
        is Romania</li>
    <li>Customer: refers to the company, organization or person that signs up to use the ICE STATION ZEBRA SRL
    ...
    <li>Personnel: refers to those individuals who are employed by ICE STATION ZEBRA SRL or are under contract to
    ...
    <li>Website: ICE STATION ZEBRA SRL's site, which can be accessed via this URL: https://www.todorescu.com</li>
...
<h1>When does ICE STATION ZEBRA SRL use end user information from third parties?</h1>
<p>ICE STATION ZEBRA SRL will collect End User Data necessary to provide the ICE STATION ZEBRA SRL services to our
    customers.</p>
...
<h1>When does ICE STATION ZEBRA SRL use customer information from third parties?</h1>
<p>We receive some information from the third parties when you contact us. For example, when you submit your email
    address to us to show interest in becoming a ICE STATION ZEBRA SRL customer, we receive information from a third
    party that provides automated fraud detection services to ICE STATION ZEBRA SRL. We also occasionally collect
...
<p>We may engage trusted third party service providers to perform functions and provide services to us, such as
    ...
    information, with these third parties to enable them to perform these services for us and for you.</p>
...
<p>ICE STATION ZEBRA SRL will collect personal information that you submit to us. We may also receive personal
...
<p>We keep your information only so long as we need it to provide ICE STATION ZEBRA SRL to you and fulfill the
    purposes described in this policy. This is also the case for anyone that we share your information with and who
    carries out services on our behalf. When we no longer need to use your information and there is no need for us
    to keep it to comply with our legal or regulatory obligations, we’ll either remove it from our systems or
...
<p>We implement a variety of security measures to maintain the safety of your personal information when you place an
    ...
    warrant the absolute security of any information you transmit to ICE STATION ZEBRA SRL or guarantee that your
...
<p>ICE STATION ZEBRA SRL is incorporated in Romania. Information collected via our website, through direct
...
<h1>Is the information collected through the ICE STATION ZEBRA SRL Service secure?</h1>
...
<p>The rights you have to request updates or corrections to the information ICE STATION ZEBRA SRL collects depend on
    your relationship with ICE STATION ZEBRA SRL. Personnel may update or correct their information as detailed in
    our internal company employment policies.</p>
...
<p>You should be aware that it is not technologically possible to remove each and every record of the information
    ...
    as soon as and to the extent reasonably and technically practicable.</p>
...
<h1>Personnel</h1>
<p>If you are a ICE STATION ZEBRA SRL worker or applicant, we collect information you voluntarily provide to us. We
    use the information collected for Human Resources purposes in order to administer benefits to workers and screen
    applicants.</p>
<p>You may contact us in order to (1) update or correct your information, (2) change your preferences with respect
    ...
    to such update, correction, change or deletion.</p>
...
<p>We reserve the right to transfer information to a third party in the event of a sale, merger or other transfer of
    all or substantially all of the assets of ICE STATION ZEBRA SRL or any of its Corporate Affiliates (as defined
    herein), or that portion of ICE STATION ZEBRA SRL or any of its Corporate Affiliates to which the Service
    relates, or in the event that we discontinue our business or file a petition or have filed against us a petition
    in bankruptcy, reorganization or similar proceeding, provided that the third party agrees to adhere to the terms
...
<p>We may disclose information (including personal information) about you to our Corporate Affiliates. For purposes
    ...
    is controlled by or is under common control with ICE STATION ZEBRA SRL, whether by ownership or otherwise. Any
...
<p>By using ICE STATION ZEBRA SRL or contacting us directly, you signify your acceptance of this Privacy Policy. If
    you do not agree to this Privacy Policy, you should not engage with our website, or use our services. Continued
...
<p>This Privacy Policy applies only to the Services. The Services may contain links to other websites not operated
    or controlled by ICE STATION ZEBRA SRL. We are not responsible for the content, accuracy or opinions expressed
    in such websites, and such websites are not investigated, monitored or checked for accuracy or completeness by
...
<h1>Advertising</h1>
<p>This website may contain third party advertisements and links to third party sites. ICE STATION ZEBRA SRL does
    not make any representation as to the accuracy or suitability of any of the information contained in those
...
<p>Advertising keeps ICE STATION ZEBRA SRL and many of the websites and services you use free of charge. We work
    hard to make sure that ads are safe, unobtrusive, and as relevant as possible.</p>
<p>Third party advertisements and links to other sites where goods or services are advertised are not endorsements
    or recommendations by ICE STATION ZEBRA SRL of the third party sites, goods or services. ICE STATION ZEBRA SRL
    takes no responsibility for the content of any of the ads, promises made, or the quality/reliability of the
    products or services offered in all advertisements.</p>

<h1>Cookies for Advertising</h1>
<p>These cookies collect information over time about your online activity on the website and other online services
    to make online advertisements more relevant and effective to you. This is known as interest-based advertising.
    They also perform functions like preventing the same ad from continuously reappearing and ensuring that ads are
    properly displayed for advertisers. Without cookies, it’s really hard for an advertiser to reach its audience,
    or to know how many ads were shown and how many clicks they received.</p>
<h1>Cookies</h1>
...
<p>Facebook pixel is an analytics tool that allows you to measure the effectiveness of your advertising by
    ...
    the right people. Facebook pixel may collect information from your device when you use the service. Facebook
    pixel collects information that is held in accordance with its Privacy Policy</p>
...
<ul>
    ...
    <li>Cookies
        <br><br>
        <p>We use Cookies to enhance the performance and functionality of our $platform but are non-essential to
    ...
    <li>Local Storage
        ...
        <p>Local Storage sometimes known as DOM storage, provides web apps with methods and protocols for storing
            ...
            enhanced capacity and no information stored in the HTTP request header.</p>
    </li><br>
    <li>Sessions
        <br><br>
        <p>$elnombre uses "Sessions" to identify the areas of our website that you have visited. A Session is a
            small piece of data stored on your computer or mobile device by your web browser.</p>
    </li><br>
</ul>
...
<p>GDPR adds some new requirements regarding how companies should protect individuals' personal data that they
    ...
    fines for breach. Beyond these facts it's simply the right thing to do. At ICE STATION ZEBRA SRL we strongly
...
<p>We are committed to helping our customers meet the data subject rights requirements of GDPR. ICE STATION ZEBRA
    SRL processes or stores all personal data in fully vetted, DPA compliant vendors. We do store all conversation
