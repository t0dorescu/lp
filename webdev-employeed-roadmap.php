        ...
        <div class="container main-container" style="background-color: white;">
            <div class="text-center">
                ...
                <p class="text-left">
                    ...
                    <br><br>
                    We created a service like anything out there.
                    <br><br>
                    ...
                    <br>
                <ol>
                    <li style="text-align: left; font-family: oswald; padding: 15px 0;">No real-life experience for actual companies, just shitty completion degrees from “boot camps” and useless half-finished projects on your resume?</li>

                    <li style="text-align: left; font-family: oswald; padding: 15px 0;">Do you believe other developers are more intelligent and they understand algorithms better than you so that’s why you’re not hired yet?</li>

                    <li style="text-align: left; font-family: oswald; padding: 15px 0;">Are you still confused about which direction to go, haven’t still yet decided on which tech to fasten your seatbelt on?</li>

                    <li style="text-align: left; font-family: oswald; padding: 15px 0;">You don’t understand what exactly companies need from you.</li>
                </ol>
                <br>
                ...
                <div style="font-family: coolvetica; letter-spacing: 1px; font-size: 1.25rem; text-align: left;">
                    ...
                    <br><br>
                    Charging for this service permits me to do it full-time with passion and dedication; it also pays my team's salaries and gives me time to offer premium support.
                    <br><br>
