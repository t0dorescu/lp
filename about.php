                    ...
                    <div class="content text-left">
                        ...
                        <div class="row">
                            <div class="col-12 flex-middle">
                                <p class="text-left">
                                    Tudor invested well over <b class="strongpoint">50,000 hours</b> in understanding front-end engineering for premium commercial projects.
                                    Working on projects with well over 400,000+ lines of code.
                                    <br><br>
                                    Through that amount of unhealthy dedication, he signs <b class="strongpoint">$75,000 contracts</b> per PWA frontend architecture, working only with top companies. Companies that generate well over <b class="strongpoint">$20,000,000 per year</b> through their SaaS solutions.
                                    <br><br>
                                    <a href="https://www.linkedin.com/in/tudortodorescu/" target="_blank" style="text-decoration: underline; font-family: oswald; color: blue">Tudor's LinkedIn Profile <i class="bi bi-linkedin"></i> (+5000 followers)</a>
                                    <br><br>
                                    CEOs/founders/HRs are begging Tudor to work for them.<br>
                                    <b class="strongpoint">He gets so many offers that he has to interview them first.</b>
                                    <br><br>
                                    <b class="bulletpoint">
                                        Here's how it all started
                                    </b>
                                    <br><br>
                                    I remember the year was <b class="strongpoint">2011</b>. It was, I think, the end of November, close to my birthday. While I was sitting in my parent's house, melting my eyes into that bright 15” screen in my dark room, I suddenly had a sobering realization. My life will be a  disaster when I arrive in my 30s.
                                    <br><br>
                                    ...
                                    <br><br>
                                    The point is, I was doing the legwork, and <b>it didn’t take me more than five months to skip wasting years of being an internship or junior in some shitty corporate company only to beg for a mid-level position.</b>
                                    <br><br>
                                    Finally, around July 2012, I had 2-3 pages on my resume, so I emailed serious software companies in the bigger cities. I got invited to maybe 4-5 interviews and got hired for a mid-level position.
                                    <br><br>
